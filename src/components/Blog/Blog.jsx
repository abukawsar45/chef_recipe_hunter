...
const Blog = () => {
  ...
  const downloadPDF = () => {
    // console.log('object');
    const capture = document.querySelector('.blog-container');
    setLoader(true);
  ...
  return (
    <div className='bg-violet-500'>
      <div className='blog-container'>
        ...
        <div className='mx-2 md:mx-6 my-2 md:my-4 px-0 md:px-4 lg:my-8 py-2 bg-slate-200 border-2 rounded'>
          ...
          <p className='px-3 md:px-8 lg:px-12 text-slate-900'>
            ...
            the DOM itself instead of being handled by the React component. In
            an uncontrolled component, the input value is managed by the
            browser, not React. The component is responsible for rendering the
            initial value, but after that, the DOM handles any updates.
            Typically, the value is read from the DOM using a ref.
          </p>
          <br />
          <h4 className='px-2 md:px-6 lg:px-10 text-xl text-amber-400'>
        ...
        <div className='mx-2 md:mx-6 my-2 md:my-4 px-0 md:px-4 lg:my-8 py-2 bg-slate-200 border-2 rounded'>
          ...
          <p className='px-3 md:px-8 lg:px-12 text-slate-900'>
            ...
            the props passed to a component have the expected type and
            structure, making it easier to catch bugs and improve the
            reliability of the application.In summary, PropTypes is a powerful
            tool for validating the types and structure of props passed to a
            React component. By using PropTypes, you can catch errors early and
        ...
        <div className='mx-2 md:mx-6 my-2 md:my-4 px-0 md:px-4 lg:my-8 py-2 bg-slate-200 border-2 rounded'>
          ...
          <p className='px-3 md:px-8 lg:px-12 text-slate-900'>
            ...
            to run JavaScript code on the server-side. It is built on top of the
            Chrome V8 JavaScript engine and provides an event-driven,
          ...
          <p className='px-3 md:px-8 lg:px-12 text-slate-900'>
            ...
            Node.js that provides a set of features for building web
            applications and APIs. It provides a minimalistic and flexible
            approach to building web applications and allows developers to
            easily handle HTTP requests, manage routes, handle middleware, and
            more.Express.js provides a framework built on top of Node.js that
            simplifies the process of building web applications and APIs.
            Together.Test and debug your Express.js application to ensure it
            works as expected.
          </p>
          <hr />
        </div>
      ...
      <div className='text-center pb-4 md:pb-6 lg:pb-8'>
        <div>
          <button
            className='btn btn-success my-2 font-serif text-slate-950 '
            onClick={downloadPDF}
